...
# path_img = r'D:\Zhurou_Du\dataset_trans\images'
# path_label = r'D:\Zhurou_Du\dataset_trans\labels'
# path_new_img = r'D:\Zhurou_Du\dataset_trans\new_images'
# path_new_label = r'D:\Zhurou_Du\dataset_trans\new_labels'

path_img = 'E:/工作与学习资料/研究生比赛项目/初中比赛/3-29/蝉'
path_label = 'E:/工作与学习资料/研究生比赛项目/初中比赛/3-29/蝉_txt_new'
path_new_img = 'E:/工作与学习资料/研究生比赛项目/初中比赛/3-29/增强后图像汇总/蝉'
path_new_label = 'E:/工作与学习资料/研究生比赛项目/初中比赛/3-29/增强后图像汇总/蝉_labels'
...
for i in range(len(img_list)):
    ...
    label =Image.open(path_label + '/' + img_list[i][0:-4] + '.jpg')
	#保存原图
