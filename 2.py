...
class DataAugmentation:
    ...
    def randomColor(image, label):
        ...
        return ImageEnhance.Contrast(brightness_image).enhance(random_factor), label  # 调整图像锐度
...
if __name__ == '__main__':
    threadOPS(r'D:\Zhurou_Du\Try_yangben1\images',
              r'D:\Zhurou_Du\Try_yangben1\new_images',
              r'D:\Zhurou_Du\Try_yangben1\labels',
              r'D:\Zhurou_Du\Try_yangben1\new_labels')